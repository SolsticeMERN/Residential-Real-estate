const About = () => {
  return (
    <div className="dark:bg-gray-100 dark:text-gray-800 rounded-2xl pb-5">
      ...
      <div className="flex flex-col lg:flex-row pt-5 px-6 lg:px-20 mb-5 items-center justify-center bg-hero overflow-hidden">
        <div className="flex flex-col  gap-6 lg:flex-row items-center max-w-8xl">
          <div className="w-full lg:w-1/2 lg:pr-32">
            <h2 className="text-4xl lg:text-5xl text-center lg:text-left text-blue-900 leading-tight font-medium">
              Who We Are <br /> Best and Award Winning <br /> Real Estate
              Business in USA 2024
            </h2>
            <h3 className="mt-6 md:mt-10 text-md lg:text-xl text-center lg:text-left text-gray-700 font-light tracking-wider leading-relaxed">
              We are the premier, award-winning real estate business in the USA,
              renowned for excellence and innovation in 2024.
            </h3>
            <div className="mt-10 flex flex-col sm:flex-row justify-center lg:justify-start">
          ...
          <div data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100" className="w-full lg:w-1/2 flex  justify-center lg:justify-end">
